import HautevilleHouse.NeuroscienceBasalGangliaLemmaCanonicalLaneLean.FinalTheorem
...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "NeuroscienceBasalGangliaLemmaCanonicalLane",
  theoremObject := "Basal Ganglia Lemma: Functional architecture of the basal ganglia supports action selection and motor learning",
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedBasalGangliaClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_basal_ganglia_endgame A
